              ...
              ${
                details.participants.length > 0
                  ? details.participants
                      .map(
                        (participant) =>
                          `<li class="participant-item"><span>${participant}</span><button type="button" class="remove-participant" data-activity="${name}" data-email="${participant}" aria-label="Remove ${participant}">&#10005;</button></li>`
                      )
                      .join("")
                  : "<li class=\"participant-item\"><span>No participants yet</span></li>"
              }
            </ul>
          </div>
        `;
