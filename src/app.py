...
activities = {
    ...
    "Swim Club": {
        "description": "Practice swimming techniques and train for swim meets",
        "schedule": "Mondays, Wednesdays, 5:00 PM - 6:30 PM",
        "max_participants": 16,
        "participants": ["lucas@mergington.edu", "mia@mergington.edu"]
    },
    "Art Studio": {
        "description": "Explore painting, drawing, and sculpture in a creative space",
        "schedule": "Wednesdays, 3:30 PM - 5:00 PM",
        "max_participants": 15,
        "participants": ["isabella@mergington.edu", "liam@mergington.edu"]
    },
    "Drama Club": {
        "description": "Prepare and perform plays, monologues, and dramatic scenes",
        "schedule": "Thursdays, 4:00 PM - 6:00 PM",
        "max_participants": 20,
        "participants": ["oliver@mergington.edu", "harper@mergington.edu"]
    },
    "Science Explorers": {
        "description": "Conduct experiments and investigate science topics",
    ...
    "Debate Team": {
        ...
        "max_participants": 14,
        "participants": ["charlotte@mergington.edu", "adam@mergington.edu"]
    }
}
